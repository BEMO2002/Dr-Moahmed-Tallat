...
const MeetingsAndConferencesHeader = () => {
    ...
    <div className="relative">
      <div className="bg-third p-12 md:p-20 text-white relative overflow-hidden">
        ...
        <div className="flex items-center justify-center flex-col gap-6 relative z-10">
          <h1
            className={`text-4xl md:text-6xl whitespace-nowrap text-primary font-bold ${isRTL ? "text-right" : "text-left"} text-center`}
          >
            {t("meetings.title")}
          </h1>
...
export default MeetingsAndConferencesHeader;
